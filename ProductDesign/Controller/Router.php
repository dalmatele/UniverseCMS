...
namespace dalmate\ProductDesign\Controller;
...
class Router implements \Magento\Framework\App\RouterInterface{
    ...
    public function __construct(
        ...
        \dalmate\Product\Model\PostFactory $postFactory
    ) {
    ...
    public function match(\Magento\Framework\App\RequestInterface $request)
    {
        ...
        $request->setModuleName('productdesign')
                ->setControllerName('view')->setActionName('index')->setParam('post_id', $post_id);
